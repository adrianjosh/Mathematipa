...
public class NPCController : MonoBehaviour, Interactable, ISavable
{
    ...
    private void Awake()
    {
        ...
        momEndgame = GetComponent<MomEndgame>();
    }
    ...
    public IEnumerator Interact(Transform initiator)
    {
        if (state == NPCState.Idle)
        {
            ...
            if (itemGiver != null && itemGiver.CantBeGiven())
            {
                yield return itemGiver.GiveItem(initiator.GetComponent<PlayerController>());
            }
            else if (fakemonGiver != null && fakemonGiver.CantBeGiven())
            {
            ...
            else if (momEndgame != null)
            {
                yield return momEndgame.TeleportToBeginning(initiator,dialog);
            }
            else
            {
